<x-student-template data="studentprofile" />
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="user-avatar text-center d-block">
                                        <img src="{{ asset('img/placeholder-male-square.png')}}" alt="User Avatar" class="rounded-circle user-avatar-xxl">
                                    </div>
                                ...
                                <div class="card-body border-top">
                                    <h3 class="font-16">Tutor Information</h3>
                                    <div class="">
                                        <ul class="list-unstyled mb-0">
                                        <li class="mb-0"><i class="fa fa-fw fa-envelope mr-2"></i>email@gmail.com</li>
                                        <li class="mb-2"><i class="fa fa-fw fa-phone mr-2"></i>(900) 123 4567</li>
                                        <li class="mb-0"><i class="fa fa-fw fa-birthday-cake mr-2"></i>19-Dec-1991 | 29yrs old</li>
                                        <li class="mb-0"><i class="fa fa-fw fa-map-marker mr-2"></i>Philippines</li>
                                    </ul>
                                    </div>
                                </div>
                                <div class="card-body border-top">
                                ...
                                <div class="card-body border-top">
                                    <h3 class="font-16">Badges</h3>
                                    <div class="">
                                        <a href="#"><span class="badge badge-secondary">TOEIC</span>
                                        <a href="#"><span class="badge badge-secondary">FOR KIDS</span>
                                        <a href="#"><span class="badge badge-secondary">FREE TALKING</span>
                                        <a href="#"><span class="badge badge-secondary">BUSINESS ENGLISH</span>
                                    </div>
                                </div>
                                <div class="card-body border-top">
                                    <h3 class="font-16">Hobbies and Interests</h3>
                                    <div>
                                    ...
                                    <div class="tab-pane fade show active" id="pills-campaign" role="tabpanel" aria-labelledby="pills-campaign-tab">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h1 class="mb-1">1 day(s)</h1>
                                                        <p>Since last online</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="media influencer-profile-data d-flex align-items-center p-2">
                                                            <div class="media-body ">
                                                                <div class="influencer-profile-data">
                                                                    <h3 class="m-b-10">Self-introduction</h3>
                                                                     <p>
                                                                     	My name is teacher Jane Doe and I came from the Philippines. I am a graduate of Bachelor of Arts in English Language Studies in one of the prestigious universities here in the Philippines. As an English major, I am knowledgeable and passionate enough about the English language. I am also optimistic and a good listener. My great skills guaranteed that I will be a great assistance. I will do my best to make our class fun and exciting way possible. Book now and see you in my class!
                                                                     </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="media influencer-profile-data d-flex align-items-center p-2">
                                                            <div class="media-body">
                                                                <h3 class="m-b-10">From Inflexion Global Staff</h3>
                                                               	Teacher Jane holds a degree with Bachelor of Arts in English Language Studies in one of the prestigious universities here in the Philippines. She does a part-time job, like an online tutorial for kids and adults. Teacher Rev is also an online seller and an entrepreneur in one of the most successful networking companies here in the Philippines. She has already exposed to different pieces of training like American Accent Training and Contact Center Training back then. She wants to be an ESL teacher because she loves to share her knowledge with other people. She is optimistic and a good listener. With her great skills, she will surely help you to improve your English learning in a fun and exciting way.
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="media influencer-profile-data d-flex align-items-center p-2">
                                                            <div class="media-body">
                                                                <h3 class="m-b-10">Tutor's Photos</h3>
                                                                <div class="row"><!--modal is located below, read comments-->
                                                                	@for ($i = 0; $i < 8; $i++)
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body text-center">
                                                        <h1 class="mb-1">$243</h1>
                                                        <p>Per Month Plateform</p>
                                                    </div>
                                                    <div class="card-body border-top">
                                                        <ul class="list-unstyled font-14">
                                                            <li><i class="fa fa-check text-success" aria-hidden="true"></i>10 one-hour sessions</li>
                                                            <li><i class="fa fa-check text-success" aria-hidden="true"></i>regular price $270, savings 10%</li>
                                                        </ul>
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body text-center">
                                                        <h1 class="mb-1">$405</h1>
                                                        <p>Per Month Plateform</p>
                                                    </div>
                                                    <div class="card-body border-top">
                                                        <ul class="list-unstyled font-14">
                                                            <li><i class="fa fa-check text-success" aria-hidden="true"></i>15 one-hour sessions</li>
                                                            <li><i class="fa fa-check text-success" aria-hidden="true"></i>regular price $345, savings 15%</li>
                                                        </ul>
                                                        <a href="#" class="btn btn-secondary btn-block btn-lg">Get Started</a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body text-center">
                                                        <h1 class="mb-1">$540</h1>
                                                        <p>Per Month Plateform</p>
                                                    </div>
                                                    <div class="card-body border-top">
                                                        <ul class="list-unstyled font-14">
                                                            <li><i class="fa fa-check text-success" aria-hidden="true"></i>20 one-hour sessions</li>
                                                            <li><i class="fa fa-check text-success" aria-hidden="true"></i>regular price $434, savings 20%</li>
                                                        </ul>
                                                        <a href="#" class="btn btn-secondary btn-block btn-lg">Get Started</a>
                                                    </div>
                                                </div>
...
<!--modal is here because z-index of modal contradicts with z-index of top navigation, issue with laravel templates *modal shows behind transition-->
@for ($i = 0; $i < 8; $i++)
